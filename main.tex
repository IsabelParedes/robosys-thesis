...
%		Formelzeichenverzeichnis / List of symbols 
% -------------------------------------------------------------------------- 
\input{05_extras/Symbols}			%  Formelzeichenverzeichnis / List of symbols

% --------------------------------------------------------------------------
%		Abkuerzungsverzeichnis / List of abbreviations
% -------------------------------------------------------------------------- 
\input{05_extras/Abbreviations}	% Abkuerzungsverzeichnis / List of abbreviations
...
\include{02_chapters/120_Levels.tex}

\include{02_chapters/130_Tasks_Scope.tex}

\include{02_chapters/140_Methodology.tex}

\include{02_chapters/150_Middleware.tex}

\include{02_chapters/160_Build.tex}

\include{02_chapters/170_Web.tex}

\include{02_chapters/180_Packages.tex}

\include{02_chapters/190_Assessment.tex}
...
\input{05_extras/A-Illustrations}
\cleardoublepage
\input{05_extras/B-Table}
\cleardoublepage
