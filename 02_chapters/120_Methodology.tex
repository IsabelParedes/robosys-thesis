...
\section{Compilation Tools}
    ...
    \subsection{Emscripten}
        ...
        TODO: what is it and why was it used
        ...
        \begin{figure}[htbp]
            ...
            \begin{tikzpicture}
                ...
                \node (emsdk) [fileBox, right of=cpp, xshift=4cm] {\textbf{Emscripten}};
            ...
            \end{tikzpicture}
            \caption{The transformation of C/C++ code to WebAssembly through Emscripten. TODO: ref}
